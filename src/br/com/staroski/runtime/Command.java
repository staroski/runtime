...
public final class Command {
    ...
    /**
     * Executa esta linha de comando ass&iacute;ncronamente, devolvendo o {@link Process processo} disparado, ficando a encargo do desenvolvedor invocar o
     * m&eacute;todo {@link Process#waitFor() waitFor()} para obter o c&oacute;digo de sa&iacute;da da aplica&ccedil;&atilde;o
     * 
     * 
     ...
     * S&oacute; faz sentido utilizar o {@link PrintWriter PrintWriter} para processos que foram inicializados atrav&eacute;s dos m&eacute;todos
     * {@link #executeAssinchronous()} ou {@link #executeAssinchronous(File)}
     * 
     * @return O objeto {@link PrintWriter PrintWriter} para se escrever na entrada do processo.
     * 
     * @throws IllegalStateException
     *             se o processo ainda n&atilde;o foi inicializado.
     */
